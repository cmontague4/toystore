...
$db       = 'connormontague_toystore';     // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'connormontague_cmonster';     // Enter YOUR cPanel username and user here
$password = 'v9nx27$4jVIq';           // Enter YOUR user password here
